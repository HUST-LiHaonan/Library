...
public class R_returnbookModel extends AbstractTableModel{
  /**
	 * 
	 */
  ...
  if(sql.equals("")){
   sql = "select  b.id,b.book_id,b.username,b.bookname,u.department,u.uclass,b.borrowdate,b.yreturndate,b.sreturndate,b.fakuan" 
			  +" from borrow_info b,user_info u"
			   +" where b.user_id=u.userid AND b.user_id =? and b.sreturndate is not null";
  }
  //中间
  //设置列名
...
//  }
 ...
 public R_returnbookModel(String sql,String user_id){
  this.init(sql,user_id);
 }
 
 //构造函数，用于初始化我的数据模型（表）
 public R_returnbookModel(String user_id){
  this.init("",user_id);
 }
